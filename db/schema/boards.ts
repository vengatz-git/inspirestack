...
export const boards = pgTable(
  "boards",
  {
    ...
    coverPinId: uuid("cover_pin_id").references(
      () => pins.id,
      {
        onDelete: "set null",
      },
  ...
  (table) => ({
    ownerIdx: index("boards_owner_idx").on(
      table.ownerId,
    ),
...
export type BoardPin =
  typeof boardPins.$inferSelect;

export type NewBoardPin =
  typeof boardPins.$inferInsert;