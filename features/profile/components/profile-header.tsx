...
export function ProfileHeader({
  ...
  return (
    <div className="flex min-w-0 items-end gap-4 max-md:flex-col max-md:items-center max-md:text-center md:translate-x-4 md:flex-row">
      <div className="relative -mt-16 h-32 w-32 shrink-0 overflow-hidden rounded-full border-4 border-background bg-muted sm:-mt-18 sm:h-36 sm:w-36 md:-mt-22 md:h-44 md:w-44">
        <Image
